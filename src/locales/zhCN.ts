...
const locale = {
  ...
  'home.Search': '搜索',
  'home.SearchMangoSwap': '搜索TXSwap',
  'home.SearchPairsAndTokens': '正在搜索代币对和代币...',
  'home.SearchMangoSwapPairsAndTokens': '搜索TXSwap代币对和代币...',
  ...
  'swap.liquidityProviderFeeHint': '每笔交易都要支付0.3%的费用。0.15%给到流动性提供者，0.05%流向TXSwap，0.10%拿去销毁。',
  ...
  'ifo.launchProject': '通过MangoSwap启动您的项目，MangoSwap是TXchain&apos最受欢迎的AMM项目和流动性提供商，将您的代币直接带到TXchain上最活跃和快速增长的社区。',
  ...
  'supple.feePaid': '每笔交易都要支付0.3%的费用。0.25%给到流动性提供者，0.05%流向TXSwap',
