...
const locale = {
  ...
  'home.Search': 'Search',
  'home.SearchMangoSwap': 'Search TXSwap',
  'home.SearchPairsAndTokens': 'Search pairs and tokens...',
  'home.SearchMangoSwapPairsAndTokens': 'Search TXSwap pairs and tokens...',
  ...
  'swap.liquidityProviderFeeHint': 'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the TXSwap treasury.',
  ...
  'ifo.launchProject': 'Launch your project with MangoSwap, TXchain&apos;s most popular AMM program and liquidity provider, to bring your tokens directly to the most active and fast-growing community on TXchain.',
  ...
  'description1forQ2': 'You can choose one or both at the same time! If you’re only committing a small amount, we recommend the Basic Sale first. Just remember you need a TXSwap Profile in order to participate.',
  ...
  'supple.feePaid': 'For each trade a 0.3% fee is paid. 0.25% goes to liquidity providers and 0.05% goes to the TXSwap treasury.',
